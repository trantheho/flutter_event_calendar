...
class _CellWidget extends StatelessWidget {
  ...
  Decoration _buildCellDecoration() {
    if (isSelected && calendarStyle.renderSelectedFirst && calendarStyle.highlightSelected) {
      return BoxDecoration(shape: BoxShape.rectangle, color: calendarStyle.selectedColor, borderRadius: BorderRadius.all(Radius.circular(11)));
    } else if (isToday && calendarStyle.highlightToday) {
      return BoxDecoration(shape: BoxShape.rectangle, color: calendarStyle.todayColor, borderRadius: BorderRadius.all(Radius.circular(11)));
